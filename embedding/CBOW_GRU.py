...
import numpy as np
import paddle
from data_preprocession import normal_data_preprocession
...
matrix = normal_data_preprocession()
corpus = [elem for sublist in matrix for elem in sublist]
...
def build_data(corpus, word2id_dict, word2id_freq, max_window_size = 5,
...
for center_words, target_words, label in build_batch(
    ...
    if step % 2000 == 0:
        embedding_matrix = skip_gram_model.embedding.weight.numpy()[0]
